...
import (
	...
	"github.com/guiserafin/go-ama/internal/store/pgstore/pgstore"
...
type Message struct {
	...
	RoomID string `json:"-"` //nao encodar esse valor
}
...
func (h apiHandler) handleSubscribe(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) {
			http.Error(w, "room not foud", http.StatusBadRequest)
			return
		}
	...
	//coloca a conexao no mapa, se nao existir ainda, cria o mapa
...
func (h apiHandler) handleCreateRoom(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Error("failed to insert room")
